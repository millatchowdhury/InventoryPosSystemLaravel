...
<script>
    ...
    async function FillUpUpdateForm(id){
        ...
        showLoader();
        let res=await axios.post("/api/customer-by-id",{id:id})
        hideLoader();
    ...
    async function Update() {
        ...
        if (customerName.length === 0) {
            ...
            let res = await axios.post("/api/update-customer",{name:customerName,email:customerEmail,mobile:customerMobile,id:updateID})
